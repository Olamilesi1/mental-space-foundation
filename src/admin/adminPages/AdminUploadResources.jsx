...
function AdminUploadResources() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(error.response?.data?.message || 'Resources upload failed!');
    }
  };
    ...
    <div className={style.blogUpload}>
        ...
        <input type="text" name="title" onChange={handleChange} placeholder='Enter the title of your resource' className={style.input}/>
        </div>
        
        <div className={style.textInputs}>
        <h3>Resource Summary</h3>
        <textarea name="summary" id="text" className={style.input} placeholder="Enter the summary of your resource" onChange={handleChange}></textarea>
        </div>
        ...
        <div className={style.textInputs}>
        <h3>Author</h3>
        <input type="text" name="author" placeholder='Author Name' className={style.input}  onChange={handleChange}/>
        </div>
       ...
       <textarea   name="contents"
                  ...
                  placeholder="Enter the contents of your blog"></textarea>
       </div>
       
       <button type="submit"  className={style.button}>UPLOAD RESOURCES</button>
